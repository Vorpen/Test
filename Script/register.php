<?php
        ...
        if(isset($_POST["btn_register"])){
            ...
            if($result){
                ...
                echo' <h5 class="uspjesno" style="text-align:center; font-size:30px; font-family:times new roman; margin-top:12%;"> Uspješno ste  se registrirali!</h5>';

                echo '	
                <form style="padding-left:44.0%" method="POST" action="../login.php" >
                <input  style="-webkit-appearance: none; 
                width:20%; height:40px; padding:5px; 
                background-color:orange; outline:none; border:none; font-size:16px;
                color:white;
                "type="submit" name="btn_login" value="Login"/>
                </form>
                ';
                echo '<div  style="padding-left:28.5%" class="gif"><img src="../media/dobro.gif"/></div>';
