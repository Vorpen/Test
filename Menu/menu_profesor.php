  ...
  <div class=" navbar-collapse" id="navbarNav">
    <ul class="nav justify-content-end ">
	  ...
	  <a class="nav-link" href="index.php?page=onama"> O nama</a>
        ...
        <li class="nav-item">
          <a class="nav-link" href="index.php?page=repozitoriji"> Repozitoriji</a>
         </li>

        
        
         <li class="nav-item" id="user">
          <a class="nav-link" href="index.php?page=profile/'.$_SESSION["username"].'"> '.$_SESSION["username"].'
          
          <img src="media/head1.png" class="icon" ></a>
         </li>
         <li class="nav-item">
