...
<div class="container-contact100">
        ...
        <h3 style="margin-bottom:20px"> Kontaktiraj '.$username.' </h3>

        

				<div class="wrap-input100 validate-input" data-validate="Name is required">
					<input class="input100" type="text" name="lastname" placeholder="Subject">
        ...
        <div class="wrap-input100 validate-input" data-validate="Name is required">
        <input class="input100" type="text" name="position" placeholder="Email">
        <span class="focus-input100-1"></span>
        <span class="focus-input100-2"></span>
      ...
      <div class="wrap-input100 validate-input" data-validate="Name is required">
      <textarea style="max-height:20%; width:90%; resize:none;" rows="3"></textarea>
     ...
     <input class="input100" style="background-color:orange; color:white; font-size:16px; padding:5px;" type="submit" class="rasprava" name="btn_postavi" value="POSALJI">
				</div>
			</form>
		</div>
	</div>
